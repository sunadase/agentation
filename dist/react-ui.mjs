...
function getUnfrozenScheduler(document2) {
...
var AnnotationPopupCSS = forwardRef(
  function AnnotationPopupCSS2({
    ...
    const unfrozen = () => getUnfrozenScheduler(
      popupRef.current?.ownerDocument ?? (typeof document === "undefined" ? void 0 : document)
    );
    useEffect(() => {
...
//# sourceMappingURL=react-ui.mjs.map